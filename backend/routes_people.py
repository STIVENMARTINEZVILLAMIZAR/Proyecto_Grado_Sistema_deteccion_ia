...
def upload_face(pid):
    ...
    try:
        ...
        s.close()
@people_bp.route('/api/people/<int:pid>', methods=['PUT'])
def update_person(pid):
    ...
    try:
        ...
        p.cargo = data.get('cargo', p.cargo)
...
@people_bp.route('/api/people/<int:pid>', methods=['DELETE'])
def delete_person(pid):
    ...
    try:
        ...
        # También eliminamos embeddings relacionados
        s.query(FaceEmbedding).filter(FaceEmbedding.person_id == pid).delete()
